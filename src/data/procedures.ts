...
export const PROCEDURES_DATABASE: ProcedureData[] = [
  ...
  },
  {
    ...
    riskLevel: 'Bajo',
    synonyms: [
      'Extirpación laparoscópica de apéndice',
      'Apendicectomía mínimamente invasiva',
    ],
  ...
  },
  {
    code: '37.33',
    title:
      'Escisión o destrucción de otra lesión o tejido del corazón, abordaje abierto',
    searchTerms: [
      'corazón',
      'escisión',
      'lesión',
  ...
  },
  {
    code: '37.94',
    title:
      'Implantación de cardioversor/desfibrilador automático, sistema total',
    searchTerms: [
      'cardioversor',
      'desfibrilador',
      'automático',
  ...
  },
  {
    ...
    riskLevel: 'Alto',
    synonyms: [
      'Reemplazo de aorta abdominal',
      'Corrección de aneurisma aórtico',
    ],
  ...
  },
  {
    ...
    riskLevel: 'Bajo',
    synonyms: [
      'Endoscopia de colon con biopsia',
      'Estudio endoscópico colónico',
    ],
  ...
  },
  {
    ...
    riskLevel: 'Medio',
    synonyms: [
      'Resección endoscópica colónica',
      'Extirpación de lesión colónica',
    ],
  ...
  },
  {
    ...
    riskLevel: 'Medio',
    synonyms: [
      'Extirpación abierta de vesícula',
  ...
  },
  {
    ...
    riskLevel: 'Bajo',
    synonyms: [
      'Extirpación laparoscópica de vesícula',
      'Colecistectomía mínimamente invasiva',
    ],
  ...
  },
  {
    code: '53.01',
    title:
      'Reparación de hernia inguinal, unilateral, no especificada de otra manera',
    searchTerms: [
      'reparación',
      'hernia',
      'inguinal',
  ...
  },
  {
    ...
    synonyms: [
      ...
      'Extracción de implante espinal',
    ],
...
export const fuzzySearch = (
  ...
  return scoredProcedures
    .filter(
      p => (p as ProcedureData & { relevanceScore: number }).relevanceScore > 0
    )
    .sort(
      (a, b) =>
        (b as ProcedureData & { relevanceScore: number }).relevanceScore -
        (a as ProcedureData & { relevanceScore: number }).relevanceScore
    )
    .slice(0, 10);
};
...
export const getRelatedProcedures = (
